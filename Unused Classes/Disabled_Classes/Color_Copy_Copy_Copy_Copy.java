...
@Autonomous
@Disabled
public class Color_Copy_Copy_Copy_Copy extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        {
            //moveMe();
            while (opModeIsActive())//((centerDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive()) || (rightDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive()) || (leftDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive())) 
            {
                if (centerDistance.getDistance(DistanceUnit.CM) > 20) {
                    if (rightDistance.getDistance(DistanceUnit.CM) > 20) {
                        if (leftDistance.getDistance(DistanceUnit.CM) > 20) {
                            if (leftDistance.getDistance(DistanceUnit.CM) > rightDistance.getDistance(DistanceUnit.CM)) {
                                rightFront.setPower(0.35);
                                rightRear.setPower(0.35);
                                leftFront.setPower(0);
                                leftRear.setPower(0);
                            }
                            else if (rightDistance.getDistance(DistanceUnit.CM) > leftDistance.getDistance(DistanceUnit.CM)) {
                                rightFront.setPower(0);
                                rightRear.setPower(0);
                                leftFront.setPower(0.35);
                                leftRear.setPower(0.35);
                            }
                            else {//if (centerDistance.getDistance(DistanceUnit.CM) > (leftDistance.getDistance(DistanceUnit.CM) + rightDistance.getDistance(DistanceUnit.CM)) / 2) {
                ...
                /*telemetry.addData("left", leftDistance.getDistance(DistanceUnit.CM) > 20);
                telemetry.addData("center", centerDistance.getDistance(DistanceUnit.CM) > 20);
                telemetry.addData("right", rightDistance.getDistance(DistanceUnit.CM) > 20);
                telemetry.addData("all", (centerDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive()) || (rightDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive()) || (leftDistance.getDistance(DistanceUnit.CM) > 20 && opModeIsActive()));
                telemetry.update();*/
            }
            resetTimer();
            while (moveTimer.time() <= 1) {
                rightFront.setPower(0.0);
                rightRear.setPower(0.0);
                leftFront.setPower(0.0);
                leftRear.setPower(0.0);
            }
            while ((centerDistance.getDistance(DistanceUnit.CM) > 5||rightDistance.getDistance(DistanceUnit.CM) > 5||leftDistance.getDistance(DistanceUnit.CM) > 5) && opModeIsActive()) {
                rightFront.setPower(0.15);
                rightRear.setPower(0.15);
                leftFront.setPower(0.15);
                leftRear.setPower(0.15);
