...
@Autonomous
@Disabled
public class MiniBotAuto_rev3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(opModeIsActive()) {
            ...
            resetTimer();
            while(moveTimer.time()<0.85&&opModeIsActive()&& !isStopRequested())
            {
            ...
            resetTimer();
            resetEncoders();
            while(moveTimer.time()<1.0 && opModeIsActive() && !isStopRequested())
            {
                rightMotor.setPower(0.013);
                leftMotor.setPower(0.013);
            }
            stopMotors();
            resetTimer();
            while(moveTimer.time()<1&&opModeIsActive()&& !isStopRequested())
