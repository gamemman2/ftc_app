...
@Autonomous
@Disabled
public class Autoboi5 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        webcamConfig = new File[]{new File("../../res/xml/teamwebcamcalibrations.xml")};
    ...
    private void initVuforia() {
        ...
        parameters.webcamCalibrationFiles= webcamConfig;
